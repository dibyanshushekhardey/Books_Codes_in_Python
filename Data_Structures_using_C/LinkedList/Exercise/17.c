...
// Function to calculate the sum of the nodes in the linked list
...
// Function to calculate the mean of the nodes in the linked list
...
int main() {
    ...
    // Calculate the mean of the nodes
