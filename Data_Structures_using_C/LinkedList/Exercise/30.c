...
int main() {
    ...
    // Prompt for information about a new employee
    int newEmpId;
    char newName[100];
    int newAge;
    float newSalary;
    ...
    // Create a new employee node with the entered information
    struct Employee* newEmployee = createEmployee(newEmpId, newName, newAge, newSalary);

    // Insert the new employee node into the linked list
